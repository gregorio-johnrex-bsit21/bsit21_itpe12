                  ...
                  <div class="card card-rounded">
                    <div class="card-body">
                      <div class="d-sm-flex justify-content-between align-items-start">
                        <div>
                          <h4 class="card-title card-title-dash">Marketing Overview</h4>
                          <p class="card-subtitle card-subtitle-dash">Track your overall marketing performance</p>
                        </div>
                        ...
                        <table class="table select-table">
                              ...
                              <th>
                                <div class="form-check form-check-flat mt-0">
                                  <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" id="check-all"><i class="input-helper"></i>
                                  </label>
                                </div>
                              </th>
                              <th>Customer</th>
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td><h6>Company name 1</h6><p>company type</p></td>
                              <td>
                                <div>
