...
<section class="relative min-h-[100dvh] md:min-h-screen w-full flex flex-col items-center overflow-hidden">
    ...
    <!-- Content wrapper: centered with padding for scroll indicator -->
    <div class="relative z-10 flex-1 flex flex-col items-center justify-center px-5 sm:px-6 max-w-4xl mx-auto w-full pt-16 pb-8 md:pt-0 md:pb-0">
    ...
    <!-- Scroll Indicator — now properly at bottom of section -->
    <button onclick="document.getElementById('features').scrollIntoView({behavior: 'smooth', block: 'start'})"
            class="relative z-10 mb-6 md:mb-10 flex flex-col items-center gap-1.5 scroll-pulse bg-transparent border-none cursor-pointer group"
            aria-label="Scroll to features">
        <span class="text-white/50 text-[10px] font-semibold tracking-[0.2em] uppercase group-hover:text-white/70 transition-colors">Scroll</span>
        <svg class="w-5 h-5 text-white/50 group-hover:text-white/70 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
    ...
    <!-- Features -->
    <section id="features" class="relative z-20 bg-white py-16 sm:py-20 md:py-28 px-5 sm:px-6 scroll-mt-0">
        <div class="max-w-5xl mx-auto">
            ...
            <!-- Who It's For — 3 cards, full width -->
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-16 md:mb-24 fade-in delay-100">
            ...
            <!-- Feature Tour — full width, stacked rows -->
            <div class="fade-in delay-200">
                ...
                <!-- Feature 1: Dashboard -->
                <div class="flex flex-col md:flex-row items-center gap-8 md:gap-12 py-10 md:py-14 border-b border-gray-100">
                    <div class="w-full md:w-56 h-44 bg-emerald-50 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-sm">
                        <svg class="w-36 h-36" viewBox="0 0 140 140" fill="none">
                    ...
                    <div class="flex-1 text-center md:text-left">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-2">Your OJT progress at a glance</h3>
                        <p class="text-sm text-gray-500 leading-relaxed mb-3 max-w-lg">See your target hours, accumulated hours, remaining hours, and missed time all on one screen. A visual progress ring shows exactly where you stand.</p>
                ...
                <!-- Feature 2: Tasks -->
                <div class="flex flex-col md:flex-row-reverse items-center gap-8 md:gap-12 py-10 md:py-14 border-b border-gray-100">
                    <div class="w-full md:w-56 h-44 bg-blue-50 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-sm">
                        <svg class="w-36 h-36" viewBox="0 0 140 140" fill="none">
                    ...
                    <div class="flex-1 text-center md:text-left">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-2">Stay on top of assigned work</h3>
                        <p class="text-sm text-gray-500 leading-relaxed mb-3 max-w-lg">Your company supervisor assigns tasks directly through the system. Track progress, view due dates, and mark tasks complete in a clean, organized list.</p>
                        <div class="flex flex-wrap gap-2 justify-center md:justify-start">
                ...
                <!-- Feature 3: Logs -->
                <div class="flex flex-col md:flex-row items-center gap-8 md:gap-12 py-10 md:py-14 border-b border-gray-100">
                    <div class="w-full md:w-56 h-44 bg-amber-50 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-sm">
                        <svg class="w-36 h-36" viewBox="0 0 160 140" fill="none">
                    ...
                    <div class="flex-1 text-center md:text-left">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-2">Your daily time record, always accurate</h3>
                        <p class="text-sm text-gray-500 leading-relaxed mb-3 max-w-lg">View your full DTR with AM and PM shifts. The system shows your actual arrival and departure times alongside scheduled times so you can see any missed minutes.</p>
                        <div class="flex flex-wrap gap-2 justify-center md:justify-start">
                ...
                <!-- Feature 4: Messaging -->
                <div class="flex flex-col md:flex-row-reverse items-center gap-8 md:gap-12 py-10 md:py-14 border-b border-gray-100">
                    <div class="w-full md:w-56 h-44 bg-purple-50 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-sm">
                        <svg class="w-36 h-36" viewBox="0 0 160 140" fill="none">
                    ...
                    <div class="flex-1 text-center md:text-left">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-2">Direct line to your supervisor</h3>
                        <p class="text-sm text-gray-500 leading-relaxed mb-3 max-w-lg">Send and receive messages with your company supervisor. Get notified of new messages instantly so you never miss an important update or instruction.</p>
                        <div class="flex flex-wrap gap-2 justify-center md:justify-start">
                ...
                <!-- Feature 5: Notes -->
                <div class="flex flex-col md:flex-row items-center gap-8 md:gap-12 py-10 md:py-14 border-b border-gray-100">
                    <div class="w-full md:w-56 h-44 bg-green-50 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-sm">
                        <svg class="w-36 h-36" viewBox="0 0 160 140" fill="none">
                    ...
                    <div class="flex-1 text-center md:text-left">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-2">Your personal journal, always private</h3>
                        <p class="text-sm text-gray-500 leading-relaxed mb-3 max-w-lg">Jot down reflections, reminders, or ideas during your OJT. Notes are stored locally on your device — private, searchable, and always available.</p>
                        <div class="flex flex-wrap gap-2 justify-center md:justify-start">
                ...
                <!-- Feature 6: Profile -->
                <div class="flex flex-col md:flex-row-reverse items-center gap-8 md:gap-12 py-10 md:py-14">
                    <div class="w-full md:w-56 h-44 bg-red-50 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-sm">
                        <svg class="w-36 h-36" viewBox="0 0 160 140" fill="none">
                    ...
                    <div class="flex-1 text-center md:text-left">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-2">Your identity in the system</h3>
                        <p class="text-sm text-gray-500 leading-relaxed mb-3 max-w-lg">View and update your personal details, set a profile picture, and manage your password securely. Your profile is what your supervisor sees when reviewing your records.</p>
                        <div class="flex flex-wrap gap-2 justify-center md:justify-start">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start gap-10 md:gap-16">
                <div class="max-w-xs">
                    ...
                    <p class="text-slate-400 text-sm leading-relaxed">
                        Official OJT management platform for the BSIT program, College of Computer Studies.
                    </p>
                </div>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 gap-8 md:gap-12 w-full md:w-auto">
                    <div>
                        ...
                        <ul class="text-sm text-slate-400 space-y-2.5">
                            <li class="flex items-center gap-2">
                                ...
                                <span class="break-all">support@chmsu.edu.ph</span>
                            </li>
                            <li class="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <ul class="text-sm text-slate-400 space-y-2.5">
                            <li>Talisay City, Negros Occidental</li>
                            <li>Bacolod City</li>
                        </ul>
                    </div>
