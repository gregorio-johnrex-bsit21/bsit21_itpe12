...
<body class="flex items-center justify-center min-h-screen p-6">
    ...
    <div id="main-box" class="opacity-0 bg-white rounded-3xl shadow-2xl w-full max-w-[390px] overflow-hidden">
        <div class="p-8 md:p-10">

            {{-- Logo --}}
            <div class="text-center font-bold mb-7 flex flex-col items-center gap-2">
                <img src="/images/logo.png" class="w-16 h-16 object-contain">
                <div>
            ...
            <p  id="form-subtitle" class="text-gray-400 text-sm mb-6">Enter your credentials to continue.</p>
            ...
            <form id="auth-form" class="flex flex-col space-y-4" onsubmit="handleSubmit(event)" autocomplete="off">
                ...
                {{-- User ID (login) / Student ID (register) --}}
                ...
                <button type="submit" id="main-btn"
                        class="w-full bg-emerald-500 text-white rounded-2xl py-4 font-bold hover:bg-emerald-600 transition-all shadow-lg shadow-emerald-100 mt-2 active:scale-95 flex items-center justify-center gap-2">
                    Login
                </button>
            </form>
    ...
    <div id="pendingModal" class="hidden bg-white rounded-3xl shadow-2xl w-full max-w-[390px] overflow-hidden box-animate-in">
        ...
        async function handleSubmit(event) {
            ...
            try {
                if (isLogin) {
                    ...
                    // ── Student register (unchanged logic) ────────────────────
